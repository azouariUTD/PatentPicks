...
var adjs = ["an extraordinary", "a vibrant", "a captivating", "an eclectic",
            "an eye-opening", "a curious", "an inspiring", "a colorful", "an animated",
            "an innovative", "the possibilities of a"],
	sentence = $('#sentence'),
	adjList = $('#adjList'),
	stop = false;
